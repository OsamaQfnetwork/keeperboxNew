...
@section('main-container')
    ...
    >
           ...
           class="text-center text-white">The Easiest way to preserve your Child's 'Keepers'</h2>
              ...
              <div class="row container d-flex justify-content-center">
                <div style="border-radius: 32px; background: #F4F6FF;" class=" p-4 col-md-5 mt-5 mr-5">
                 ...
                 font-style: normal;
                 font-weight: 400;
                 line-height: 21px; /* 131.25% */">Easy-to-Use system</li>
                 <li style="color: #6C6C6D;
                 font-feature-settings: 'clig' off, 'liga' off;
                 font-family: Poppins;
                 font-size: 16px;
                 font-style: normal;
                 font-weight: 400;
                 line-height: 26px; /* 162.5% */">Store originals in your Keeper-Box</li>
                 <li style="color: #6C6C6D;
                 font-feature-settings: 'clig' off, 'liga' off;
                 font-family: Poppins;
                 font-size: 16px;
                 font-style: normal;
                 font-weight: 400;
                 line-height: 26px; /* 162.5% */">Archival quality storage box </li>
                 <li style="color: #6C6C6D;
                 font-feature-settings: 'clig' off, 'liga' off;
                 font-family: Poppins;
                 font-size: 16px;
                 font-style: normal;
                 font-weight: 400;
                 line-height: 26px; /* 162.5% */">Well-lit & edited images</li>
                 <li class="" style="color: #6C6C6D;
                 font-feature-settings: 'clig' off, 'liga' off;
                 font-family: Poppins;
                 font-size: 16px;
                 font-style: normal;
                 font-weight: 400;
                 line-height: 26px; /* 162.5% */">Effortlessly preserve memories </li>
                 <li style="color: #6C6C6D;
                 font-feature-settings: 'clig' off, 'liga' off;
                 font-family: Poppins;
                 font-size: 16px;
     ...
     font-style: normal;
     font-weight: 400;
     line-height: 21px; /* 131.25% */">Keeper-Box: Boxes with tracking ID's</li>
     <li style="color: #6C6C6D;
     font-feature-settings: 'clig' off, 'liga' off;
     font-family: Poppins;
     font-size: 16px;
     ...
     font-style: normal;
     font-weight: 400;
     line-height: 26px; /* 162.5% */">Keeper-Admin: Cloud-based portal for schools </li>
     <li style="color: #6C6C6D;
     font-feature-settings: 'clig' off, 'liga' off;
     font-family: Poppins;
     font-size: 16px;
     font-style: normal;
     font-weight: 400;
     line-height: 26px; /* 162.5% */">Keeper-App: App-Based image delivery & sharing for parents</li>
                ...
                background: #F4F6FF;" class="col-md-5 mt-5 container rounded-lg ml-5 p-4">
                 ...
                 font-style: normal;
                 font-weight: 400;
                 line-height: 26px; /* 162.5% */">Digitally-preserve artwork forever</li>
                 <li style="color: #6C6C6D;
                 font-feature-settings: 'clig' off, 'liga' off;
                 font-family: Poppins;
                 font-size: 16px;
                 font-style: normal;
                 font-weight: 400;
                 line-height: 26px; /* 162.5% */">Share artwork with family & friends</li>
                 <li style="color: #6C6C6D;
                 font-feature-settings: 'clig' off, 'liga' off;
                 font-family: Poppins;
                 font-size: 16px;
               ...
               font-weight: 400;
               line-height: 26px; /* 162.5% */">
               Affordable per-scan pricing</li>
               ...
               <div class="row justify-content-center mt-5">
                <div class="col-md-3">
                 ...
                 background: #283570; color: #fff; width: 400px;" class="btn">
       ...
       class="text-center text-white">Your schools best rund-canser</h2>
          ...
          <div class="row container d-flex justify-content-center">
            <div style="border-radius: 32px; background: #F4F6FF;" class=" p-4 col-md-5 mt-5 mr-5">
             ...
             font-style: normal;
             font-weight: 500;
             line-height: 28px; /* 116.667% */">restores:</h2>
             <li style="color: #000;
             font-feature-settings: 'clig' off, 'liga' off;
             font-family: Poppins;
             font-size: 16px;
             font-style: normal;
             font-weight: 400;
             line-height: 21px; /* 131.25% */">Easy-to-Implant System</li>
             <li style="color: #6C6C6D;
             font-feature-settings: 'clig' off, 'liga' off;
             font-family: Poppins;
             font-size: 16px;
             font-style: normal;
             font-weight: 400;
             line-height: 26px; /* 162.5% */">KeeseBox: Boxes with Tracking ID's</li>
             <li style="color: #6C6C6D;
             font-feature-settings: 'clig' off, 'liga' off;
             font-family: Poppins;
             font-size: 16px;
             font-style: normal;
             font-weight: 400;
             line-height: 26px; /* 162.5% */">Keeperorder: Online Box Ordering for</li>
             <li style="color: #6C6C6D;
             font-feature-settings: 'clig' off, 'liga' off;
             font-family: Poppins;
             font-size: 16px;
             font-style: normal;
             font-weight: 400;
             line-height: 26px; /* 162.5% */">Parents KeeperAdmin: Cloud-Based Admin</li>
             <li style="color: #6C6C6D;
             font-feature-settings: 'clig' off, 'liga' off;
             font-family: Poppins;
             font-size: 16px;
             font-style: normal;
             font-weight: 400;
             line-height: 26px; /* 162.5% */">Software tor schools KeeperApp: App-</li>
             <li style="color: #6C6C6D;
             font-feature-settings: 'clig' off, 'liga' off;
             font-family: Poppins;
             font-size: 16px;
             font-style: normal;
             font-weight: 400;
             line-height: 26px; /* 162.5% */">Based Image Delivery & Share for Parents</li>

            <li class="mt-3" style="color: #000;
            font-feature-settings: 'clig' off, 'liga' off;
            font-family: Poppins;
            font-size: 16px;
            font-style: normal;
            font-weight: 400;
            line-height: 21px; /* 131.25% */">Ongoing fund-raising Revenue</li>
            <li style="color: #000;
            font-feature-settings: 'clig' off, 'liga' off;
            font-family: Poppins;
            font-size: 16px;
            font-style: normal;
            font-weight: 400;
            line-height: 21px; /* 131.25% */">Popular service for Parent</li>
            <li style="color: #000;
            font-feature-settings: 'clig' off, 'liga' off;
            font-family: Poppins;
            font-size: 16px;
            font-style: normal;
            font-weight: 400;
            line-height: 21px; /* 131.25% */">Flexible Schedule - set by the School</li>
            <li style="color: #000;
            font-feature-settings: 'clig' off, 'liga' off;
            font-family: Poppins;
            font-size: 16px;
            font-style: normal;
            font-weight: 400;
            line-height: 21px; /* 131.25% */">Volunteer magnate scanning</li>
            ...
            background: #F4F6FF;" class="col-md-5 mt-5 container rounded-lg ml-5 p-4">
             ...
             font-style: normal;
             font-weight: 400;
             line-height: 26px; /* 162.5% */"> Great fund-raise Stream</li>
             <li style="color: #6C6C6D;
             font-feature-settings: 'clig' off, 'liga' off;
             font-family: Poppins;
             font-size: 16px;
           ...
           Build's community connections</li>
