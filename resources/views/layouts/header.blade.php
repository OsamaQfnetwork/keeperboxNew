  ...
  <body class="presentation-page">
    ...
    <div class="container position-sticky z-index-sticky top-0">
      <div class="row">
        <div class="col-12">
          <nav
            style="background-color: #1f2b65; color: #fff; padding: 15px"
          ...
          >
            <div class="container-fluid px-2">
              ...
              <div
                class="text-white collapse navbar-collapse w-100 mt-2 pt-3 pb-2 py-lg-0"
                id="navigation"
              >
                <ul class="navbar-nav navbar-nav-hover ms-auto">
                  <li class="nav-item dropdown dropdown-hover mx-2">
                    <a
                      ...
                      role="button"
                      class="text-white nav-link ps-2 d-flex cursor-pointer align-items-center"
                  ...
                  FEATURES & BENEFITS
                      <i
                        ...
                        class="text-white text-xs fa-solid arrow fa-chevron-down"
                      >
                      </i>
                    </a>
                    <div
                      class="dropdown-menu dropdown-menu-animation dropdown-md border-radius-lg p-2 mt-0 mt-lg-3"
                  ...
                  >
                    <button
                      style="font-family: sans-serif"
                      class="btn btn-white rounded-pill btn-sm mt-1"
                    >
                    Get Started
                    </button></a>
                  </li>
